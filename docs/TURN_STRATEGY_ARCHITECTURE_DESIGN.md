...
- [x] Create type definitions in template/types.py
- [x] Create factory base classes
- [x] Create config builder and validators

### Phase 2: Strategy Factories
- [x] Implement StartStrategyFactory
- [x] Implement StopStrategyFactory
- [x] Implement TurnAnalyzerFactory
- [x] Implement MuteStrategyFactory

### Phase 3: Integration
- [x] Update template model to include turn_strategy_config
- [x] Update pipeline.py to use new builder
- [x] Add Redis default configuration
- [x] Backward compatibility handling

### Phase 4: Testing & Documentation
- [x] Create example templates
- [x] Update documentation
- [x] Test all strategy combinations
