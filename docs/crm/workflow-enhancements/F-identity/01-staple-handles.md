# F/01 — Staple carries the loser's handles (P3)

**Track F · step 1** · **Kind**: fix · **PR title**: `fix(crm): a staple attaches the merged-away customer's free handles to the survivor (enh F/01)` · **Depends on**: nothing; **needs a ruling from Swaroop against ADR 0021 before starting** (ask; do not assume; if the ruling is no, do F/02 and close the track) · **Notes**: §2 identity OBSERVATION, §11 P3
