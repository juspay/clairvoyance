# C/01 — Re-drive quarantined events

**Track C · step 1** · **Kind**: feat · **PR title**: `feat(crm): list and re-drive quarantined spine events (enh C/01)` · **Depends on**: nothing (rollout 04 is merged) · **Notes**: §3 record
