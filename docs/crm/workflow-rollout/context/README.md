...
| `nits.md` | N1–N21: consistency, hygiene and doc points. N1 → 20, N18–N20 → 00, N2–N3 and N8–N17 → 34; N4–N7 need no code. | Before phase 00; skim later. |
...
- §16.3 gaps: G1 → 19; G2/G3 → 18; G4 → 21; G5 → 20 (condition), 22 (http), 23 (split); G6 → 24; G7 → 06; G8 → 16; G9 → 09; G10 → 25; G11 → 26; G12 → 08.
- §11 probable issues: P3 → 29; P4 → 30; P6 → 31; P7 → 32; P8 → 33; P5 (publish read race) closed by pinning (10–14).
- Nits: N1 → 20; N18–N20 → 00; N2–N3, N8–N17 → 34; N4–N7 are connectivity docs/ops notes with no code change (N4 stale comment, N5–N7 deliberate).
