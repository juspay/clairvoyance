...
| `nits.md` | N1–N21: consistency, hygiene and doc points; every one is mapped to a rollout phase or an enhancements step below. | Before phase 00; skim later. |
...
- §16.3 gaps: G1 → 19; G2/G3 → 18; G7 → 06; G8 → 16; G9 → 09; G12 → 08; G4 → enhancements A/02; G5 → A/01, A/03, A/04; G6 → track B; G10 → A/05; G11 → track D.
- §11 probable issues: P3 → F/01; P4 → G/01; P6 → E/01; P7 → G/02; P8 → C/02; P5 closed by pinning (10–14).
- Nits: N1 → A/01; N18–N20 → 00; N12, N14–N16 → A/06; N8–N9 → E/02; N10–N11 → F/02; N2, N3, N17 → G/04; N13 → C/02; N4–N7 need no code.
