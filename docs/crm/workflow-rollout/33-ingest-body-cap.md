# Phase 33 — Ingest body cap that actually caps (P8)

**Kind**: fix · **PR title**: `fix(crm): the ingest door caps the body it reads, not just the header it is told` · **Depends on**: nothing · **Notes**: §3 record OBSERVATION, §11 P8 · **Wave 7**
