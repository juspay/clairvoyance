# Phase 31 — Suppression probes by channel (P6)

**Kind**: feat · **PR title**: `feat(crm): is_suppressed answers per channel — a WhatsApp STOP no longer blocks voice` · **Depends on**: 19 · **Notes**: §1 platform OBSERVATION, §11 P6 · **Wave 7**
