...
class FeatureFlagService:
    """
    Feature flag service using DevCycle OpenFeature provider.
    ...
    def _devcycle_to_env_key(self, feature_key: str) -> str:
        ...
        Universal Convention: uppercase and replace - with _
        
        Examples:
        - voice-noise-reduction → VOICE_NOISE_REDUCTION
        - deepgram-vad-events → DEEPGRAM_VAD_EVENTS
        - aic-enhancement-level → AIC_ENHANCEMENT_LEVEL
        """
    ...
    def is_enabled(self, env_key: str, default_value: bool = False, user_data: Dict[str, Any] = None) -> bool:
        """
    ...
    def get_variable(self, variable_key: str, default_value: bool = False, user_data: Dict[str, Any] = None) -> bool:
        """
    ...
    def get_string(self, env_key: str, default_value: str = "", user_data: Dict[str, Any] = None) -> str:
    ...
    def get_number(self, env_key: str, default_value: float = 0.0, user_data: Dict[str, Any] = None) -> float:
    ...
    def _create_evaluation_context(self, user_data: Dict[str, Any] = None) -> EvaluationContext:
        """
