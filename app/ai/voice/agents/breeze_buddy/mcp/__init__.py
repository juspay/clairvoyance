...
def _create_mcp_tool_handler(
    ...
    async def handler(args: Dict[str, Any], flow_manager: Any) -> FlowResult:
        ...
        params = FunctionCallParams(
            ...
            # A required field on FunctionCallParams, same as llm/context
            # above: synthetic params for a direct tool dispatch, with no
            # real pipeline worker behind this call to supply one.
