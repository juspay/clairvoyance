...
async def mutate_customer_attribute(
    customer_id: str, key: str, mutation: Mutation
    ...
    return await atomically(
        _mutate_customer_attribute_in_txn, customer_id, key, mutation
    )


async def _mutate_customer_attribute_in_txn(
    txn: DbTxn, customer_id: str, key: str, mutation: Mutation
) -> Optional[Tuple[str, Any]]:
