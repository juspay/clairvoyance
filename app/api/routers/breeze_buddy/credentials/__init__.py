...
async def create_credential_endpoint(
    ...
    Values are encrypted at rest when GCP KMS is configured.
    """
...
async def get_credential_endpoint(
    ...
    """
    return await get_credential_handler(credential_id, current_user)
...
async def update_credential_endpoint(
    ...
    - New values will be re-encrypted if KMS is configured
    """
