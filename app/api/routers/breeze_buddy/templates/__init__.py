...
from .rbac import require_admin, require_admin_or_merchant_owner
...
async def delete_template_by_id(
    ...
    - Checks if any active leads (BACKLOG/RETRY/IN_PROGRESS) are using this template
    ...
    """
    require_admin(current_user, operation="delete templates")
