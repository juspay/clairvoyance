"""
Template version history (lineage) and rollback endpoints.

Endpoints:
- GET    /templates/{id}/versions            - Version history (metadata only)
- GET    /templates/{id}/versions/{version}  - Full snapshot of one version
- POST   /templates/{id}/rollback            - Restore a version as the new head
"""
