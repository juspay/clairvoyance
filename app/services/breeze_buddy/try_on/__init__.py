...
The only try-on state kept is a counter in the session state, a claim per
``request_id``, and, for ten minutes, one generated image keyed by
``request_id`` (see ``cache``).
"""
