...
META_WHATSAPP_APP_ID = os.getenv("META_WHATSAPP_APP_ID", "")
META_WHATSAPP_APP_SECRET = os.getenv("META_WHATSAPP_APP_SECRET", "")
META_WHATSAPP_EMBEDDED_SIGNUP_CONFIGURATION_ID = os.getenv(
    "META_WHATSAPP_EMBEDDED_SIGNUP_CONFIGURATION_ID", ""
)
...
WHATSAPP_PAYMENT_LINK_TEMPLATE_LANGUAGE = os.getenv(
    "WHATSAPP_PAYMENT_LINK_TEMPLATE_LANGUAGE", "en"
)
