...
async def GEMINI_PROMPT_GENERATION_MODEL() -> str:
    """Returns the Gemini model used for prompt generation."""
    return await get_config(
        "GEMINI_PROMPT_GENERATION_MODEL", "gemini-2.5-flash-lite", str
    )
