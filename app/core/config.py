...
TWILIO_WEBSOCKET_URL = os.getenv("TWILIO_WEBSOCKET_URL", "wss://ten-diabetes-sugar-ceremony.trycloudflare.com/agent/voice/breeze-buddy/twillio/callback/order-confirmation")
