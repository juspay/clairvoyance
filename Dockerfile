...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    AIC_MODEL_PATH=/app/models/voice/aic/quail_l_8khz_v7.aicmodel \
    AIC_MODEL_PATH_16KHZ=/app/models/voice/aic/quail_l_16khz_v7.aicmodel \
    AIC_VOICE_FOCUS_MODEL_PATH=/app/models/voice/aic/quail_vf_2_2_l_16khz.aicmodel \
...
RUN --mount=type=secret,id=gcp_token \
    if [ -f /run/secrets/gcp_token ]; then \
        ...
        gcloud storage cp --access-token-file=/run/secrets/gcp_token ${AIC_BUCKET_PATH}/quail_l_8khz_v7.aicmodel /app/models/voice/aic/ || echo "Warning: Failed to download quail_l_8khz_v7.aicmodel"; \
        gcloud storage cp --access-token-file=/run/secrets/gcp_token ${AIC_BUCKET_PATH}/quail_l_16khz_v7.aicmodel /app/models/voice/aic/ || echo "Warning: Failed to download quail_l_16khz_v7.aicmodel"; \
        gcloud storage cp --access-token-file=/run/secrets/gcp_token ${AIC_BUCKET_PATH}/quail_vf_2_2_l_16khz.aicmodel /app/models/voice/aic/ || echo "Warning: Failed to download quail_vf_2_2_l_16khz.aicmodel"; \
    else \
