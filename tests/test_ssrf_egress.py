...
async def test_307_preserves_method_and_body_on_the_callers_own_host():
    ...
    The hop here stays on the host the caller addressed. A 307 to a DIFFERENT
    host drops the body for the same reason 302 does, which is the case the
    docstring above describes; see
    tests/test_ssrf_credential_scope.py::test_a_307_does_not_replay_the_body_to_another_host.
    """
    session = _FakeSession(
